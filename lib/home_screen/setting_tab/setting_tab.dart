...
class _SettingTabState extends State<SettingTab> {
            ...
            InkWell(
              ...
              child: Container(
               ...
               child: Row(
                 ...
                 children: [
                   Text(provider.localeLang == 'en'? AppLocalizations.of(context)!.english:AppLocalizations.of(context)!.arabic,
  ...
  void showLangBottomSheet(){
    showModalBottomSheet(context: context, builder: (buildContext)=>LangBottomSheet()
    );}

  void showThemeBottomSheet(){
    showModalBottomSheet(context: context, builder: (buildContext)=>ThemeBottomSheet()
    );
  }
}
